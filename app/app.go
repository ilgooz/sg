...
import (
	...
	appparams "github.com/test/sg/app/params"
	"github.com/test/sg/x/sg"
	sgkeeper "github.com/test/sg/x/sg/keeper"
	sgtypes "github.com/test/sg/x/sg/types"
...
func New(
	...
	app.sgKeeper = *sgkeeper.NewKeeper(
        appCodec, keys[sgtypes.StoreKey], keys[sgtypes.MemStoreKey],
	)
	...
	app.mm = module.NewManager(
		...
		transferModule,
		sg.NewAppModule(appCodec, app.sgKeeper),
